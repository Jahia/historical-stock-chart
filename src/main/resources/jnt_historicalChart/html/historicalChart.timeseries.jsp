...
<c:if test="${not renderContext.editMode}">
    ...
    <template:addResources type="css" resources="templates/timeseries.css"  />
    <template:addResources type="javascript" resources="envision/custom/yepnope.js"/>
    <template:addResources type="javascript" resources="envision/custom/timeseries.js"/>
    ...
    <template:addResources >
        ...
        <div id="stock-chart-content">
            <h4 id="title-finance-${uuid}">Timeseries</h4>
...
<c:if test="${renderContext.editMode}">
    ...
    <div class="stock-chart-content-edit">
        <img src="${url.currentModule}/img/timeseries-preview.png">
    </div>
</c:if>
